...
CLUSTER_PER_URL = '/api/cluster/metrics?interval=1h&fields=iops,throughput,latency'
POOL_PER_URL = '/api/storage/aggregates/%s/metrics?interval=1h&fields=iops,throughput,latency'
VOLUME_PER_URL = '/api/storage/luns/%s/metrics?interval=1h&fields=iops,throughput,latency'
...
FC_PER_URL = '/api/network/fc/ports/%s/metrics?interval=1h&fields=iops,' \
             'throughput,latency'
ETH_PER_URL = '/api/network/ethernet/ports/%s/metrics?interval=1h&fields=throughput'
